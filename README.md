...
<head>  
  ...
  <style>  
    body {  
      ...
      background: linear-gradient(to bottom, #cbeefd, #ffffff);  
      color: #333;  
    }  header {  
...
.hero {  
  height: 100vh;  
  background: url('tu-imagen-inicio.jpg') no-repeat center center/cover;  
  display: flex;  
...
<body>    <div class="hero" id="inicio">  
  ...
  <img src="tipos.jpg" alt="Ilustración de diferentes tipos de drogas" />  
</section>  
...
<section id="estadisticas">  
  ...
  <img src="graficas.jpg" alt="Gráfico de consumo" />  
</section>  
